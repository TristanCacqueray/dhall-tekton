...
demo = subprocess.Popen(['dhall-to-yaml', '--omit-empty', '--file', './examples/task.dhall'], stdout=subprocess.PIPE)
newdoc = doc[:dhallstart + 2] + open('examples/task.dhall').read().split('\n') + \
